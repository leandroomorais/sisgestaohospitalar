...
CREATE TABLE prontuario_diagnosticos (
...
CREATE TABLE token_redefinicao (
  id BIGINT NOT NULL,
   ...
   CONSTRAINT pk_tokenredefinicao PRIMARY KEY (id)
);
...
ALTER TABLE atendimento ADD CONSTRAINT FK_ATENDIMENTO_ON_CONSULTA FOREIGN KEY (consulta_id) REFERENCES consulta (id);
...
ALTER TABLE consulta ADD CONSTRAINT FK_CONSULTA_ON_AVALIACAO FOREIGN KEY (avaliacao_id) REFERENCES avaliacao (id);
...
ALTER TABLE sinais_vitais ADD CONSTRAINT FK_SINAISVITAIS_ON_TRIAGEM FOREIGN KEY (triagem_id) REFERENCES triagem (id);
...
ALTER TABLE token_redefinicao ADD CONSTRAINT FK_TOKENREDEFINICAO_ON_PROFISSIONAL FOREIGN KEY (profissional_id) REFERENCES profissional (id);
...
ALTER TABLE prontuario_atestados ADD CONSTRAINT fk_proate_on_prontuario1VxLa2 FOREIGN KEY (id_prontuario) REFERENCES prontuario (id);

ALTER TABLE prontuario_diagnosticos ADD CONSTRAINT fk_prodia_on_diagnostico FOREIGN KEY (id_diagnostico) REFERENCES diagnostico (id);

ALTER TABLE prontuario_diagnosticos ADD CONSTRAINT fk_prodia_on_prontuario FOREIGN KEY (id_prontuario) REFERENCES prontuario (id);
