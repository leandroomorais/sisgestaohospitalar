...
public class ListaAtendimentoDataTablesService {

	private String[] cols = { "classificacaoDeRisco", "cidadao.sexo", "cidadao.nome", "profissionalDestino.nome",
			"tipoServicos", "status.descricao", "condutaCidadao", "" };
