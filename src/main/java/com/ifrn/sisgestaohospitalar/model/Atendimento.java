...
public class Atendimento {
	...
	public String toString() {
		return "Atendimento [id=" + id + ", responsavel=" + responsavel + ", numeroRegistro=" + numeroRegistro
				+ ", cidadao=" + cidadao + ", condutaTipoServico=" + condutaTipoServico + ", condutaCidadao="
				+ condutaCidadao + ", dataEntrada=" + dataEntrada + ", status=" + status + ", caraterAtendimento="
				+ caraterAtendimento + ", profissionalDestino=" + profissionalDestino + ", historicoStatus="
				+ historicoStatus + ", atendimentoProcedimentos=" + atendimentoProcedimentos + ", triagem=" + triagem
				+ "]";
	}
