...
//	@ResponseBody
//	public ResponseEntity<List<Procedimento>> findByNome(HttpServletRequest request) {
...
//	@ResponseBody
//	public ResponseEntity<Procedimento> findByCodigo(HttpServletRequest request){
