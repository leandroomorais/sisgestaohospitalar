...
public class LeitorTXTMedicamentos {
	...
	public void lerTXTMedicamentos(String arquivoMedicamento) throws IOException {
		...
		while ((linha = bufferedReader.readLine()) != null) {
			...
			System.out.println("CODIGO: " + medicamentoDTO[0] + " | Principio ativo: " + medicamentoDTO[1] + " | CONCENTRAÇÃO: " + medicamentoDTO[2] + " | CODIGO FORMA: " + medicamentoDTO[3] + " | FORN.: " + medicamentoDTO[4]);
			
			//System.out.println("Linha: " + i++ + " | Unidade Fornecimento: " + medicamentoDTO[4]);
			...
			if (medicamentoDTO[3] != "" || medicamentoDTO[3] != null) {
				medicamento.setCodigoFormaFarmaceutica(Long.parseLong(medicamentoDTO[3]));
			}
