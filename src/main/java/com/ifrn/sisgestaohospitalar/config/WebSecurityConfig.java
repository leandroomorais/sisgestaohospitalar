...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/cidadao/adicionar").permitAll()
		.antMatchers("/cidadao/salvar").permitAll()
		.antMatchers("/cidadao/atualizar").permitAll()
		.antMatchers("/cidadao/detalhar/**").permitAll()
		.antMatchers("/cidadao/editar/**").permitAll()
		.antMatchers("/cidadao/detalhar/**").permitAll()
		.antMatchers("/cidadao/busca-local").permitAll()
		.antMatchers("/cidadao/busca-cadsus").permitAll()
