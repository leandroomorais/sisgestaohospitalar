...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/index").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
		.antMatchers("/cidadao/adicionar/").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
		.antMatchers("/cidadao/salvar").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
		.antMatchers("/cidadao/atualizar").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
		.antMatchers("/cidadao/detalhar/**").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
		.antMatchers("/cidadao/editar/**").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
		.antMatchers("/cidadao/busca-local").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
		.antMatchers("/cidadao/busca-cadsus").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
...
//		.antMatchers("/uso-medicamento/**").hasAnyAuthority("MEDICO", "ENFERMEIRO", "ADMINISTRADOR", "TECNICO", "AUXILIAR")
		...
		//.antMatchers("/triagem/add-procedimento").hasAnyAuthority("ADM", "ATD", "MED", "ENF", "TEC", "SUPER")
		//.antMatchers("/triagem/delete-procedimento").hasAnyAuthority("ADM", "ATD", "MED", "ENF", "TEC", "SUPER")
		//.antMatchers("/triagem/imprimir").hasAnyAuthority("ADM", "ATD", "MED", "ENF", "TEC", "SUPER")
