...
import com.ifrn.sisgestaohospitalar.repository.EnderecoCidadaoRepository;
...
public class Inicializador implements ApplicationListener<ContextRefreshedEvent> {
	...
	@Autowired
	private EnderecoCidadaoRepository enderecoCidadaoRepository;

	@Override
	public void onApplicationEvent(ContextRefreshedEvent event) {

		/*
		 * Role role = new Role(); role.setNome("ADM"); roleService.save(role);
		 * 
		 * Role roleTec = new Role(); roleTec.setNome("TEC"); roleService.save(roleTec);
		 * 
		 * Role roleEnf = new Role(); roleEnf.setNome("ENF"); roleService.save(roleEnf);
		 * 
		 * Role roleMed = new Role(); roleMed.setNome("MED"); roleService.save(roleMed);
		 * 
		 * Role rolesuper = new Role(); rolesuper.setNome("SUPER");
		 * roleService.save(rolesuper);
		 * 
		 * String cnes = "2380633"; String file = System.getProperty("user.dir") +
		 * "/uploads/XmlParaESUS21_241360.xml";
		 * 
		 ...
		 * profissional.setCns("781274801470008"); profissional.setCpf("47748001049");
		 * profissional.setDatanascimento("20-06-1994"); profissional.setSexo("M");
		...
		/*
		 * Municipio municipio = municipioRepository.getOne(1L); Logradouro logradouro =
		 * logradouroRepository.getOne(1L); EnderecoCidadao enderecoCidadao = new
		 * EnderecoCidadao(2, "620", "", "Zeca Pedro", "59900-000",
		 * "Mariana Guedes do Rêgo", municipio, logradouro);
		 * //enderecoCidadaoRepository.saveAndFlush(enderecoCidadao); Cidadao
		 * cidadaoMariana = new Cidadao(); Cidadao cidadaoLucia = new Cidadao(); Cidadao
		 * cidadaoLucijane = new Cidadao(); Cidadao cidadaoLuana = new Cidadao();
		 * Cidadao cidadaoIsabel = new Cidadao(); Cidadao cidadaoLuciano = new
		 * Cidadao(); Cidadao cidadaoLuciana = new Cidadao(); Cidadao cidadaoDjaneidy =
		 * new Cidadao();
		 * 
		 * cidadaoMariana.setCns("110525916150007"); cidadaoMariana.setCodigoetnia(0);
		 * cidadaoMariana.setCodigonacionalidade(1); cidadaoMariana.setCodigoraca(03);
		 ...
		 * cidadaoMariana.setSexo("F"); cidadaoMariana.setTelefone("84981561303");
		 * cidadaoMariana.setEndereco(enderecoCidadao);
		 * cidadaoMariana.setMunicipioNascimento(municipio);
		 */
		 

		/*
		 * cidadaoLucia.setBairro("CENTRO"); cidadaoLucia.setCep("59945000");
		 * cidadaoLucia.setCns("187458243740005"); cidadaoLucia.setCodigoetnia(0);
		 * cidadaoLucia.setCodigoibgemunicipio("2407252");
		 * cidadaoLucia.setCodigologradouro(81); cidadaoLucia.setCodigonacionalidade(1);
		 ...
		 * cidadaoLucia.setCpf("11111111111"); cidadaoLucia.setEmail("");
		 ...
		 * cidadaoLucia.setNumeroendereco("90"); cidadaoLucia.setSexo("F");
		 * cidadaoLucia.setTelefone(""); cidadaoLucia.setNomemunicipio("MAJOR SALES");
		 * 
		 * cidadaoLuana.setBairro("CENTRO"); cidadaoLuana.setCep("59945000");
		 * cidadaoLuana.setCns("277821448980007"); cidadaoLuana.setCodigoetnia(0);
		 * cidadaoLuana.setCodigoibgemunicipio("2407252");
		 * cidadaoLuana.setCodigologradouro(81); cidadaoLuana.setCodigonacionalidade(1);
		 ...
		 * cidadaoLuana.setCpf("22222222222"); cidadaoLuana.setEmail("");
		 ...
		 * cidadaoLuana.setNumeroendereco("99"); cidadaoLuana.setSexo("F");
		 * cidadaoLuana.setTelefone(""); cidadaoLuana.setNomemunicipio("MAJOR SALES");
		 * 
		 * cidadaoLuciano.setBairro("CENTRO"); cidadaoLuciano.setCep("59945000");
		 * cidadaoLuciano.setCns("138569771740007"); cidadaoLuciano.setCodigoetnia(0);
		 * cidadaoLuciano.setCodigoibgemunicipio("2407252");
		 * cidadaoLuciano.setCodigologradouro(81);
		 * cidadaoLuciano.setCodigonacionalidade(1); cidadaoLuciano.setCodigoraca(03);
		 * cidadaoLuciano.setDatanascimento(LocalDate.parse("1985-11-07"));
		 * cidadaoLuciano.setComplementoendereco("CASA");
		 * cidadaoLuciano.setCpf("33333333333"); cidadaoLuciano.setEmail("");
		 ...
		 * cidadaoLuciano.setNumeroendereco("81"); cidadaoLuciano.setSexo("M");
		 * cidadaoLuciano.setTelefone("84981561303");
		 * cidadaoLuciano.setNomemunicipio("MAJOR SALES");
		 * 
		 * cidadaoDjaneidy.setBairro("CENTRO"); cidadaoDjaneidy.setCep("59945000");
		 * cidadaoDjaneidy.setCns("744456497940009"); cidadaoDjaneidy.setCodigoetnia(0);
		 * cidadaoDjaneidy.setCodigoibgemunicipio("2407252");
		 * cidadaoDjaneidy.setCodigologradouro(81);
		 * cidadaoDjaneidy.setCodigonacionalidade(1); cidadaoDjaneidy.setCodigoraca(03);
		 * cidadaoDjaneidy.setDatanascimento(LocalDate.parse("1985-11-07"));
		 * cidadaoDjaneidy.setComplementoendereco("CASA");
		 * cidadaoDjaneidy.setCpf("44444444444"); cidadaoDjaneidy.setEmail("");
		 ...
		 * cidadaoDjaneidy.setNumeroendereco("81"); cidadaoDjaneidy.setSexo("F");
		...
		/*
		 * cidadaoService.save(cidadaoLuciano); cidadaoService.save(cidadaoLucia);
		 * cidadaoService.save(cidadaoLuana); cidadaoService.save(cidadaoDjaneidy);
		 */

		/*
		 * try { leitorXmlEsus.lerXmlEsus(file, cnes); } catch (JAXBException e) {
		 * e.printStackTrace(); } catch (ParseException e) { e.printStackTrace(); }
		 * String urlProcedimentos = System.getProperty("user.dir") +
		 * "/SigtapSUS/tb_procedimento.txt";
		 * 
		 * String urlRegistros = System.getProperty("user.dir") +
		 * "/SigtapSUS/tb_registro.txt";
		 * 
		 * String urlCid = System.getProperty("user.dir") + "/SigtapSUS/tb_cid.txt";
		 * 
		 * String urlOcupacao = System.getProperty("user.dir") +
		 * "/SigtapSUS/tb_ocupacao.txt";
		 * 
		 * String urlRelationProced_Registro = System.getProperty("user.dir") +
		 * "/SigtapSUS/rl_procedimento_registro.txt";
		 * 
		 * String urlRelationProced_Cid = System.getProperty("user.dir") +
		 * "/SigtapSUS/rl_procedimento_cid.txt";
		 * 
		 * String urlRelationProced_Ocupacao = System.getProperty("user.dir") +
		 * "/SigtapSUS/rl_procedimento_ocupacao.txt";
		 * 
		 * try { leitorTxtSigtap.lerTxtCid(urlCid);
		 ...
		 * leitorTxtSigtap.relacionamentoProcedimento_Ocupacao(
		 * urlRelationProced_Ocupacao);
		 * leitorTxtSigtap.relacionamentoProcedimento_Registro(
		 * urlRelationProced_Registro);
		 * 
